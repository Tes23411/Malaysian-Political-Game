           ...
           <div className="space-y-2 rounded-lg bg-gray-700 p-3">
             ...
             <label className="flex items-center space-x-3 cursor-pointer">
               <input 
                  type="radio" 
                  name="focus" 
                  checked={focus === 'Multi-Racial'} 
                  onChange={() => setFocus('Multi-Racial')}
                  className="h-4 w-4 text-blue-600 bg-gray-900 border-gray-600 focus:ring-blue-500"
                />
               <span className="text-sm">Multi-Racial (National)</span>
             </label>
             {affiliation.ethnicity.includes('Sabah') && (
               <label className="flex items-center space-x-3 cursor-pointer">
                 <input 
                    type="radio" 
                    name="focus" 
                    checked={focus === 'Multi-Racial (Sabah)' as Ethnicity} 
                    onChange={() => setFocus('Multi-Racial (Sabah)' as Ethnicity)}
                    className="h-4 w-4 text-blue-600 bg-gray-900 border-gray-600 focus:ring-blue-500"
                  />
                 <span className="text-sm">Multi-Racial (Sabah)</span>
               </label>
             )}
             {affiliation.ethnicity.includes('Sarawak') && (
               <label className="flex items-center space-x-3 cursor-pointer">
                 <input 
                    type="radio" 
                    name="focus" 
                    checked={focus === 'Multi-Racial (Sarawak)' as Ethnicity} 
                    onChange={() => setFocus('Multi-Racial (Sarawak)' as Ethnicity)}
                    className="h-4 w-4 text-blue-600 bg-gray-900 border-gray-600 focus:ring-blue-500"
                  />
                 <span className="text-sm">Multi-Racial (Sarawak)</span>
               </label>
             )}
           </div>
        </div>
